...
public class Mob extends Rectangle {
	 ...
	 public int mobSize = 52;  //Mob Size !
	 ...
	 public int walkFrame=0, walkSpeed=40; // mob movement
	 public void physic(){
		 if(walkFrame>=walkSpeed){
				if(direction == right){
					x +=1;
				}else if (direction ==upward){
					y -= 1;// makes mob moves like crazy =P >>>>>>>>>>>>> >>>>>>>> >>>>>>>
				}else if (direction == downward){
					y+=1;
				}else if (direction == left){
					x-=1;
				}
				// all good down there , need to check up !
				mobWalk +=1;
				...
				if(mobWalk == Screen.room.blockSize){
					if(direction == right){
						...
						yC -= 1;// makes mob moves like crazy =P >>>>>>>>>>>>> >>>>>>>> >>>>>>>
						hasUpward = true;
					}else if (direction == downward){
						yC += 1;
						hasDownward = true;
